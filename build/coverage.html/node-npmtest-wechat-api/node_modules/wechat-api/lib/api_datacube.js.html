...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-wechat-api/node_modules/wechat-api/lib/api_datacube.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-wechat-api/node_modules/wechat-api/lib/api_datacube.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-wechat-api/node_modules/wechat-api/lib/</a> &#187; api_datacube.js</div>
</div>
<div class="body">
...
methods.forEach(function (method) {
  exports[method] = <span class="fstat-no" title="function not covered" >function (begin, end, callback) {</span>
<span class="cstat-no" title="statement not covered" >    this.preRequest(this['_' + method], arguments);</span>
  };
});
&nbsp;
/*!
...
*/
methods.forEach(function (method) {
  exports['_' + method] = <span class="fstat-no" title="function not covered" >function (begin, end, callback) {</span>
<span class="cstat-no" title="statement not covered" >    var data = {</span>
      begin_date: begin,
      end_date: end
    };
<span class="cstat-no" title="statement not covered" >    var url = this.endpoint + '/datacube/' + method.toLowerCase() + '?access_token=' + this.token.accessToken;</span>
